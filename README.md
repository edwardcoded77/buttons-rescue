...
![The page as I inherited it](before.png)
![The page after the restoration](after.png)
...
- Fixed the CSS selector to match the <div class="story"> element in index.html.
